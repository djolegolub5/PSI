...
<body style = "background-color: #333333;">
    ...
    <h2 class = "text-center text-light">
        Uspešno ste objavili rang listu za izabrani kviz!
    </h2>
    <br><br>
    <h2 class = "text-center" style = "color: red;">
        Molimo vas da rezultate kviza u buduće ne objavljujete pre isteka roka!
    </h2>

    <div class = "text-center">
    <a class = "btn btn-success" href = "pocetna_administrator.html" style = "margin: auto;">Povratak na početnu stranicu</a>
    </div>

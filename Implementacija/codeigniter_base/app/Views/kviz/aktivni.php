...
<body style = "background-color: #333333;">
    ...
    <h1 class = "text-center text-light">Aktivni kvizovi</h1>
    <?php
        for($i = 0; $i < sizeof($aktivni); $i++) {
            echo '
            <div class = "aktivni_kviz container-fluid text-center">
            <h2 class = "text-light">Kviz:' . $aktivni[$i]->Naslov . '</h2>
            <div>
            ...
            echo '     
                    <tr>
                    <td colspan="2">
                        <b>Kviz se završava: <span id = "josKoliko">' . $aktivni[$i]->DatumDo . '</b></span>
                    </td>
                    <td colspan="2">
                    ...
                    <tr>
                    <td colspan="4">
                         <a class = "btn btn-danger" href = "' . site_url("Admin/objaviAktivan/{$aktivni[$i]->ID}") . '">Objavi rezultate</a>
                    </td>
                    </tr>
                </table>
            </div>

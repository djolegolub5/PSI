                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                              ...
                              <b><a class="nav-item nav-link" style = "color: white; font-size: 120%;" href="<?= site_url("Registrovan/anketa")?>">Ankete</a></b>
                                        ...
                                        <div class="form-holder">
                                            <div class="form-content">
                                                <div class="form-items">
                                                    ...
                                                    <p>Popuni anketu.</p>
                                                    <form method="POST" action="<?=site_url("Registrovan/zavrsena_anketa/$forma->ID")?>">
                                                        ...
                                                        <div class='col-sm-12'>
                                                            <select class='form-select mt-3' required name=$pitanje->ID>
                                                                <option selected disabled value='' checked >Izaberi stavku.</option>";
                                                                foreach ($odgovori[$pitanje->ID] as $odgovor) {
                                                                    echo "<option value=$odgovor->ID>$odgovor->Tekst</option>";
                                                                }
                                                                echo"
                                                            </select>
                                                        </div>
                                                       ...
                                                       <div class='col-sm-12' aria-required='true'>";
                                                        ...
                                                        <div class="form-button mt-3">
                                                            <a href='<?= site_url("Registrovan/zavrsena_anketa/$forma->ID")?>'><input type="submit"
                                                            class="btn btn-primary btn-dark" value="Završi anketu"></a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>

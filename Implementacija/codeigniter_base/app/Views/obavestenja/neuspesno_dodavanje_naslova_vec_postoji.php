...
<head>
    ...
    <title>Neuspesno dodavanje naslova</title>
...
<body style="background-color: black;">
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        ...
        <div class="row centrirano align-items-centerX" style="height:700px">
            <div class="col-sm-12">
                <h1 style="color:white;">Naslov već postoji u bazi.</h1>
                <br>
                <h2><a href="<?= site_url("Admin/index") ?>" class="naziv" >Vrati se na pocetnu stranicu.</a></h2>

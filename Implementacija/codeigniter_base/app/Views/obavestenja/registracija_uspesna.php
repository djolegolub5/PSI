...
<body style="background-color: black;">
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                          <a class="nav-item nav-link" style = "color: white; font-size: 120%;" href="#">O nama</a>
                          <a class="nav-item nav-link" style = "color: white; font-size: 120%;" href="prijava.html">Uloguj se</a>
                          <a class="nav-item nav-link" style = "color: white; font-size: 120%;" href="registracija.html">Registruj se</a>
        ...
        <div class="row centrirano align-items-centerX" style="height:700px">
            <div class="col-sm-12">
                <h1 style="color:white;">Uspešno ste se registrovali.</h1>
                <br>
                <h2><a href="pocetna_ulogovan.html" class="naziv" >Vrati se na početnu stranicu.</a></h2>
